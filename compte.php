...
<div class="block-services-1 py-5">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="modifiercompte.php" class="btn btn-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p><strong>Mot de passe:</strong>
                                    <span id="password" class="password-mask">*******</span>
                                    <button id="show-password" class="btn btn-sm btn-outline-primary ml-2">
                                        Afficher
                                    </button>
                                </p>
                            </div>
    ...
    <script>
        ...
        showPasswordBtn.addEventListener('click', () => {
            if (password.classList.contains('password-mask')) {
                password.classList.remove('password-mask');
                password.textContent = '<?php echo $user['mdp']; ?>';
                showPasswordBtn.textContent = 'Masquer';
            } else {
                password.classList.add('password-mask');
