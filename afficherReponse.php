...
<div style="width:1450px;"id="layoutSidenav_content">
                ...
                <tbody>
                        ...
                        $pdo=config::getConnexion();
                            $query = $pdo->prepare("SELECT * FROM reponse ORDER BY idreponse ASC");
                            $query->execute();
        ...
        ?>
                ...
                <td>
                    <a href="supprimerReponse.php?idreponse=<?php echo $row['idreponse']; ?>">Supprimer</a>
                </td>
